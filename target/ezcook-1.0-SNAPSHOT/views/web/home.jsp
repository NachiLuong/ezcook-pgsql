...
<div id="container">
                                ...
                                <div class="penci-mag-featured-content">
                                    <div class="feat-text">
                                        <h3><a title="${food.name}"
                                               href="#">${food.name}</a></h3>
                                        <div class="feat-meta">
                                            <span class="feat-time">${cs.formatTime(food.createdOn)}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="content" class="mx-auto">
                ...
                <c:forEach var='food' items="${listFoodNew}" varStatus="status">
                    <div class="food item text-center">
                        ...
                        <div>
                            ...
                            <span class="author">written by <a href="<c:url value='/#'/>">Ezcook</a>  |  ${cs.formatTime(food.createdOn)}</span>
                            <p id="demo"></p>
        ...
        <button onclick="loadMore()" class="btn btn-primary" style="text-align: center">Xem tiếp...</button>
        <hr>
