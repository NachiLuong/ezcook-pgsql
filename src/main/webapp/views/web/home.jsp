...
<div id="container">
                                ...
                                <div class="penci-mag-featured-content">
                                    <div class="feat-text">
                                        <h3><a title="${food.name}"
                                               href="#">${food.name}</a></h3>
                                        <div class="feat-meta">
                                            <span class="feat-time"><c:out value='${cs.formatTime(food.createdOn)}'/></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="content" class="mx-auto">
        ...
        <div class="wrapper">
            <button onclick="loadMore()" class="btn btn-primary" style="text-align: center"><i class="fa fa-refresh fa-spin loading"></i>Xem tiếp...</button>
        </div>
        <hr>
